...
def main():
    ...
    new_label, event_num = multidataloader.label, multidataloader.event_num
    ...
    # update here
    dataset1_kg, dataset1_tail_len, dataset1_relation_len = multidataloader.dataset1_kg.get()
    dataset2_kg, dataset2_tail_len, dataset2_relation_len = multidataloader.dataset2_kg.get()
    dataset3_kg, dataset3_tail_len, dataset3_relation_len = multidataloader.dataset3_kg.get()
    dataset4_kg, dataset4_tail_len, dataset4_relation_len = multidataloader.dataset4_kg.get()
    ...
    # update here
    save_result("/data/dingli/mydata/KG-DDIBaselines/results/task2_MFG-FENN/", "all", result_all)
    save_result("/data/dingli/mydata/KG-DDIBaselines/results/task2_MFG-FENN/", "each", result_eve)
